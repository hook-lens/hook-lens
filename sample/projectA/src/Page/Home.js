    ...
    <div style={{ height: "100vh" }}>
      ...
      <div className="latest-news">
        ...
        <h1 style={{ fontSize: "200%" }}>
          ...
          <span style={{ fontWeight: "bold" }}>전통주</span>
        </h1>
